      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl text-gray-900 mb-4 font-extrabold">
            Services That <span className="bg-linear-to-r from-[#5EBEAF] to-[#3B9B8E] bg-clip-text text-transparent">Drive Growth</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div className="absolute inset-0 bg-linear-to-r from-[#5EBEAF] to-[#3B9B8E] opacity-0 group-hover:opacity-5 transition-opacity"></div>
                
                <CardHeader>
                  <div className="w-14 h-14 rounded-xl bg-linear-to-r from-teal-100 to-emerald-100 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <Icon className="w-7 h-7 text-[#3B9B8E]" />
                  </div>
                  <CardTitle className="text-gray-900 font-semibold text-2xl">{service.title}</CardTitle>
                </CardHeader>
                <CardContent>
